...
const config = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    filename: '[runtime]/[name].[chunkhash:8].js',
  ...
  module: {
    rules: [
      {
        test: /\.(s)?css$/,
        use: isProd ? [MiniCssExtractPlugin.loader, 'css-loader', 'sass-loader', 'postcss-loader'] : ['vue-style-loader', 'css-loader', 'sass-loader', 'postcss-loader'],
      }
    ]
  },
  plugins: [
